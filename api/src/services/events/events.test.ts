...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2024-01-06T13:55:03.212Z',
        updatedAt: '2024-01-06T13:55:03.212Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2024-01-06T13:55:03.212Z'))
    expect(result.updatedAt).toEqual(new Date('2024-01-06T13:55:03.212Z'))
  })
